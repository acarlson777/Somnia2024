...
public class DreamJournalDialogueManager : MonoBehaviour
{
    ...
    void Awake()
    {
        dialogueBoxPrefab = Resources.Load("DreamJournalDialogue") as GameObject; // get the Dialogue Prefab in the Resources Folder named "CharacterDialogueBox"
    ...
    /// </summary>
    public static bool PopDreamJournalDialogue(string[] textLines)
    {
        ...
        GameObject dialogueBox = GameObject.Find("DreamJournalDialogue");
        if (dialogueBox != null)
        {
            return false;
        }
        ...
        if (dialogueBoxPrefab == null)
        {
            dialogueBoxPrefab = Resources.Load("DreamJournalDialogue") as GameObject;
        }
        if (canvas == null)
        {
        ...
        dialogueBox.name = "DreamJournalDialogue"; // Set its name to "CharacterDialogueBox"
