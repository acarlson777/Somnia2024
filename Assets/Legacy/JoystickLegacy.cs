...
public class JoystickLegacy : MonoBehaviour
{
    ...
    JoystickCircleLegacy largestCircle;
    JoystickCircleLegacy mediumCircle;
    JoystickCircleLegacy smallCircle;
    ...
    void Start()
    {
        ...
        largestCircle = largest.GetComponent<JoystickCircleLegacy>();
        mediumCircle = medium.GetComponent<JoystickCircleLegacy>();
        smallCircle = small.GetComponent<JoystickCircleLegacy>();
